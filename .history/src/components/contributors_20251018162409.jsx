...
Join us in our journey to keep the spirit of Braj alive and flourishing for generations to come.
  ...
  <div className="team-members">
    ...
    <div className="team-member">
      ...
      <h3>About the Developer</h3>
      <p>
        🏆 Debugging like a detective, deploying like a dev-ops ninja. 🥷 MERN Stack & AI certified by Meta. Certified in WebDev MERN Stack by Meta, APIs, and AI, ready to make the web smarter.
